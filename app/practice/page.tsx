...
import { ArrowLeft, ArrowRight, BookOpen, Check, Gamepad2, Lightbulb, RotateCcw, Settings, Sparkles, Trophy, X } from 'lucide-react';
...
export default function PracticePage() {
  ...
  return <main className="min-h-screen bg-[#f5f7f2] text-[#17221b]">
    ...
    {!playing ? <section className="mx-auto max-w-6xl px-5 py-10 md:px-8">
      ...
      <div className="mb-5 flex items-center justify-between"><Button variant="ghost" onClick={() => setPlaying(false)}><ArrowLeft />All games</Button><div className="flex items-center gap-2 text-sm font-medium text-[#637067]"><Trophy size={17} className="text-[#d09a3a]" />{correct} correct</div></div>
